...
public class MainToAddContact {
	// TODO Auto-generated method stub
	static ArrayList<ToAddContact> address = new ArrayList<>();
	...
	public static void add() {
		...
		ToAddContact addressBook = new ToAddContact(null, null, null, null, option, null, null);
	...
	public static void update() {
		...
		for (ToAddContact addressBook : address) {
