...
public class AddressBookMainIO {

	public static Map<String, AddressBookIO> addressBookMap = new HashMap<>();
	...
	public static void addContacts() {
		System.out.println("Enter the name of the address book you want to add the contact:");
		String bookname = cs.next();

		if (addressBookMap.containsKey(bookname)) {
			AddressBookIO tempBook = addressBookMap.get(bookname);
			tempBook.addContact();
	...
	public static void displayAddressBook() {
		...
		if (addressBookMap.containsKey(bookname)) {
			AddressBookIO address = addressBookMap.get(bookname);
	...
	public static void viewContactByState() {
		...
		addressBookMap.values().stream().forEach(addressBook -> stateList.addAll(addressBook.getContact().stream()
				.filter(contact -> contact.getCity().equalsIgnoreCase(stateName)).collect(Collectors.toList())));
	...
	public static void writeToFile() {
		...
		String path = "C:\\Users\\Prudhvi\\address_Books\\address_Books\\src\\address_Book\\addressbooks.txt";
	...
	public static void readFromFile() {
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("C:\\Users\\Prudhvi\\address_Books\\address_Books\\src\\address_Book\\addressbooks.txt"))) {
            String line = " ";
            while (line != null){
