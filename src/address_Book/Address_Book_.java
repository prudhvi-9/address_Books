...
public class Address_Book_ {

	Scanner cs = new Scanner(System.in);
	ArrayList<Contact_Person_> contacts = new ArrayList<>();
	...
	public void addContact() {
		...
		List<Contact_Person_> duplicateName = contacts.stream().filter(contact -> contact.getFirstName().equals(fName))
		...
		Contact_Person_ contact = new Contact_Person_();
	...
	public void editDetails() {
		...
		for (Contact_Person_ addressBook : contacts) {
	...
	public void deleteDetails() {
		...
		for (Contact_Person_ tempContact : contacts) {
	...
	public void setContact(ArrayList<Contact_Person_> contact) {
		this.contacts = contact;
	}

	public Collection<Contact_Person_> getContact() {
		return contacts;
