...
public class Address_Book {
	...
	ArrayList<Contact_Person> contacts = new ArrayList<>();
	...
	public void addContact() {
		...
		List<Contact_Person> duplicateName = contacts.stream().filter(contact -> contact.getFirstName().equals(fName))
	...
	public void editDetails() {
		...
		for (Contact_Person addressBook : contacts) {
	...
	public void deleteDetails() {
		...
		for (Contact_Person tempContact : contacts) {
	...
	public void setContact(ArrayList<Contact_Person> contact) {
		this.contacts = contact;
	}

	public Collection<Contact_Person> getContact() {
		return contacts;
