...
public class Address_Book_Main_ {
	...
	public static void searchContactByCity() {
		List<Contact_Person_> cityList = new ArrayList<>();
	...
	/*
	 * To view person by State.
	 */
	public static void viewContactByState() {
		List<Contact_Person_> stateList = new ArrayList<>();
	...
	/*
	 * To get number of contact persons by city.
	 */
	public static void getCountByCity() {
		...
		System.out.println("Count of " + cityName + "city is:" + count);
	}
}
